...
broker_ip = "192.168.1.170"                    # 필요시 수정
...
DEFAULT_PRIVKEY_PATH = os.path.join(certs_ecdsa_dir, "ecdsa_private_fake.pem")
        ...
        while True:
            for file in os.listdir(publish_dir):
                ...
                try:
                    ...
                    print("Success sending file(updates/pqc_signature)")
